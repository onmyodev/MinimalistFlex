...
<div <?php post_class( "image" ) ?>>
    <div class="singular-main image-main">
        <div class="author-avatar image-avatar"><?php echo get_avatar( $mf_id, 120 ); ?></div>
        <div class="image-content">
            <p class="image-author"><a class="author-link" href="<?php echo esc_url( get_author_posts_url($mf_id) ) ?>"><?php the_author() ?></a>&nbsp;|&nbsp;<?php get_template_part( 'templates/datetime' ) ?></p>
