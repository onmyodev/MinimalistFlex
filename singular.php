            ...
            <div class="singular-adjacent-posts">
                <div class="singular-adjacent-post singular-previous-post panel">
                    ...
                    <?php $mf_previous_post = get_previous_post(); ?>
                        <?php if ( $mf_previous_post ): ?>
                            <a class="singular-adjacent-post-link" href="<?php echo esc_url( get_permalink( $mf_previous_post ) ); ?>"><?php echo get_the_title( $mf_previous_post ); ?>&nbsp;</a>
                        <?php else: ?>
                ...
                <div class="singular-adjacent-post singular-next-post panel">
                    ...
                    <?php $mf_next_post = get_next_post(); ?>
                        <?php if ( $mf_next_post ): ?>
                            <a class="singular-adjacent-post-link" href="<?php echo esc_url( get_permalink( $mf_next_post ) ); ?>"><?php echo get_the_title( $mf_next_post ); ?>&nbsp;</a>
                        <?php else: ?>
